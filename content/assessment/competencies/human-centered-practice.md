...
| CIS 251 (Y2 Fall) | Threat identification, authentication, authorization; least data collection (data minimization) as a security, privacy, and ethical principle. Confirmed against CIS 251's real SLOs. | | CIS 400 (Y2 Spring) | Responsibility retrospective — the team project includes an assessed, individually-written ethical accountability reflection. Confirmed. |
