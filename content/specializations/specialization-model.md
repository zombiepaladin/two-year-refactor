...
| **Specialization stack** | Degree-specific courses (e.g. cybersecurity | courses) | **Differs** — this *is* the specialization |
...
A fuller per-course redesign (what each cybersecurity course can now drop and what depth it can add) is worth a dedicated pass with the security faculty.
